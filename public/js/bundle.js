...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoiZmxhc2hiYWNrMDU0IiwiYSI6ImNsZWgwcnB3ajB0czIzc21xN3d3a3dieTcifQ.B75fA-5_GRJGJba3uKxicA';
  ...
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(data, type) {
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          _context.prev = 0;
          urlEndpoint = type === 'password' ? 'update-my-password' : 'update-me';
          _context.next = 4;
          return (0, _axios.default)({
            method: 'PATCH',
            url: "http://127.0.0.1:8080/api/v1/users/".concat(urlEndpoint),
            data: data
          });
        case 4:
          res = _context.sent;
...
var bookTour = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(tourId, startDate) {
    var stripe, session;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          _context.prev = 0;
          stripe = Stripe('pk_test_51MhTrUJk8bflUZ08XfhsZDFW5L2OMHSI28XrYha2sfJIJYN3dR3az9qSfUGokyDgi01qSVXmRfUuLGIqcLCEsSdx00Qqv44SYF'); // 1) Get checkout session from API
          _context.next = 4;
          return (0, _axios.default)("http://127.0.0.1:8080/api/v1/bookings/checkout-session/?tour=".concat(tourId, "&startDate=").concat(startDate));
        case 4:
...
var postReview = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(tourId, rating, review) {
    var res;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          ...
          return (0, _axios.default)({
            method: 'POST',
            url: "http://127.0.0.1:8080/api/v1/tours/".concat(tourId, "/reviews"),
            data: {
              rating: rating,
              review: review
            }
        ...
        case 3:
          res = _context.sent;
          if (res.data.status === 'success') {
            (0, _alert.showAlert)('success', 'Your review has been posted!');
            window.setTimeout(function () {
              location.reload(true);
            }, 1000);
          }
...
var bookTourToggle = document.getElementById('book-tour-toggle');
var bookTourBtns = document.querySelectorAll('.book-tour');
var modal = document.querySelector('.modal');
var modalList = document.querySelector('.modal-list');
var postReviewBtn = document.querySelector('.btn-post-review');
var postReviewForm = document.querySelector('.modal-review-form');
var submitReviewBtn = document.querySelector('.btn--review');
if (mapBox) {
  var locations = JSON.parse(document.getElementById('map').dataset.locations);
  (0, _mapbox.displayMap)(locations);
}
if (loginForm) loginForm.addEventListener('submit', /*#__PURE__*/function () {
...
if (bookTourBtns) bookTourBtns.forEach(function (bookTourBtn) {
...
if (postReviewForm) {
  ...
  var starSvgs = document.querySelectorAll('.reviews__star.reviews__star--form');
  starSvgs.forEach(function (star, index) {
...
if (submitReviewBtn) submitReviewBtn.addEventListener('click', /*#__PURE__*/function () {
  var _ref6 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee6(e) {
    var tourId, rating, review;
    return _regeneratorRuntime().wrap(function _callee6$(_context6) {
      while (1) switch (_context6.prev = _context6.next) {
        case 0:
          e.preventDefault();
          submitReviewBtn.textContent = 'Posting...';
          tourId = submitReviewBtn.dataset.tourId;
          rating = document.querySelector('input[name="rating"]:checked').value;
          review = document.querySelector('input#review').value;
          _context6.next = 7;
          return (0, _review.postReview)(tourId, rating, review);
        case 7:
